        ...
        <div className="bg-neutral-100 min-h-screen font-work-sans flex justify-center items-center">
            ...
            <div className="max-w-80 md:max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-auto flex justify-center items-center">
                ...
                <div className="text-center">
                    ...
                    <Link to="/" className="inline-flex items-center justify-center px-3 md:px-4 lg:px-6 py-3 mb-2 text-sm md:text-base lg:text-lg text-white bg-red-500 font-semibold rounded-md hover:bg-red-600 sm:w-auto sm:mb-0" data-primary="green-400" data-rounded="rounded-2xl" data-primary-reset="{}">
                        Back To Home
                    </Link>
