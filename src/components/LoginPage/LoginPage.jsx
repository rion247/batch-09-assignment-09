        ...
        <div className='font-poppins'>
            ...
            <div className='flex items-center justify-center'>
                ...
                <div className="w-full mx-auto max-w-80 md:max-w-xl lg:max-w-2xl xl:max-w-3xl rounded-md sm:p-8 text-gray-900">
                    ...
                    <form className='mb-3 md:mb-4 lg:mb-5 xl:mb-6'>
                        ...
                        <div className="mt-1 md:mt-2 lg:mt-3 xl:mt-4 mb-3 md:mb-4 lg:mb-5 xl:mb-6">
                            ...
                            <input type="email" name="email" placeholder="Enter Your Email Address" className="w-full p-5 border rounded-md border-neutral-200 text-neutral-500" />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="password" name="password" id="password" placeholder="Enter Your Password" className="w-full p-5 border rounded-md border-neutral-200 text-neutral-500" />
                        </div>
                    ...
                    <button className="w-full p-3 md:p-4 xl:p-5 text-base md:text-lg xl:text-xl font-semibold rounded-md bg-red-500 hover:bg-red-600 text-white">Login</button>
