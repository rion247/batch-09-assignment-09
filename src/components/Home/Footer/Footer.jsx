...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-gradient-to-b from-neutral-800 to-neutral-600 text-white">
            ...
            <div className="py-6 text-sm text-center text-gray-100">© 1968 Modern Living Co. All rights reserved.</div>
        </footer>
    );
};
