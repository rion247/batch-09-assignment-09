    ...
    return (
        ...
        <div className=" text-black">
            <div className=" xl:container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
                ...
                <p className="px-6 py-2 font-semibold text-center sm:font-bold text-sm md:text-lg lg:max-w-xl xl:max-w-4xl text-gray-900">{description.slice(0, 75)}</p>
                <div className="flex justify-center items-center space-x-3">
                    ...
                    <div>
                        ...
                        <Link className="flex items-center py-2 space-x-1 text-sm text-blue-500" to={`/testimonial/${id}`}>
